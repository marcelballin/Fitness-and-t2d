...
///Cohort 
	 ...
	 mata 
  function AF5(at) {
    // at5 is F(t|unexposed,Z)
    // nominator is F(t,Z)
    return(1 - at[5]/((at[1]+at[2]+at[3]+at[4]+at[5])/5))
}
...
timevar(time) ///
atvar(diabetes_std1 diabetes_std2 diabetes_std3 diabetes_std4 diabetes_std5) ///
///
     userfunction(AF5) userfunctionvar(AF5_diabetes) ci
...
at5(wmax2 0 wmax3 0 wmax4 0 wmax5 1 wmax6 0 wmax7 0 wmax8 0 wmax9 0 wmax10 0) ///
timevar(time) ///
atvar(diabetes_bwstd1 diabetes_bwstd2 diabetes_bwstd3 diabetes_bwstd4 diabetes_bwstd5) ///
///							
     userfunction(AF5) userfunctionvar(AF5_diabetes) ci
